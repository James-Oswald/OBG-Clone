...
from torch.nn import ModuleList, Sequential, Linear, BatchNorm1d, ReLU, Dropout, LSTM
...
class GNN(LightningModule):
    def __init__(self, model: str, in_channels: int, out_channels: int,
        ...
        for _ in range(num_layers):
            self.norms.append(LSTM(768, hidden_channels, num_layers))

        self.mlp = Sequential(
            Linear(hidden_channels, hidden_channels),
            LSTM(768, hidden_channels, num_layers),
            ReLU(inplace=True),
