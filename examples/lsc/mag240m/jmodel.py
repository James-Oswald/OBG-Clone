...
class GNN(LightningModule):
    ...
    def training_step(self, batch, batch_idx: int):
        ...
        # tweaked from cross_entropy -> BCEWithLogitsLoss
        loss_function = F.BCEWithLogitsLoss(reduction='mean')
        train_loss = loss_function(y_hat, batch.y)
...
if __name__ == '__main__':
    ...
    #dropout from 0.5 -> 0 (dropout tends to hurt accuracy)
    parser.add_argument('--dropout', type=float, default=0)
    parser.add_argument('--epochs', type=int, default=20)
    #removed option for graphsage, as gat has better accuracy
